...
const objReadData: any = new dataHandling();

test.describe('@smoke Create Company without mandatory parameters', () => {
    test('Create Company without Mandatory Fields', async ({ applicationGeneric, loginPage, companies }: any) => {
        const objCompanyData: any = await objReadData.readSingleRowtestdataFromExcel("CRM.xlsx", "Companies", "TC1");
